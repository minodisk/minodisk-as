package com.flashdynamix.utils {
	...
	public class SWFProfiler {
      ...
      addEvent(content.gcBtn, MouseEvent.CLICK, gc);
		}
      ...
      removeEvent(content, MouseEvent.CLICK, gc);
		}

		/**
		 * Garbage collect the SWF.
		 */
		public static function gc(e:Event = null) : void {
			try {
				System.gc();
...
internal class ProfilerContent extends Sprite {
  ...
  internal var gcBtn : Sprite;
    ...
    gcBtn = new Sprite();
		...
		mb.x = 65;
		mb.y = 90;
    gcBtn.buttonMode = true;
    gcBtn.graphics.beginFill(0xff0000);
    gcBtn.graphics.drawRect(0, 0, 10, 10);
    gcBtn.graphics.endFill();
    gcBtn.y = 5;
	...
	private function resize(e : Event = null) : void {
		...
		infoTxtBx.x = stage.stageWidth - infoTxtBx.width - 20;
    gcBtn.x = stage.stageWidth - gcBtn.width - 5;
	}
}